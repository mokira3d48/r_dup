...
Cloneable referential to initialize R-DUP with the best practice.
...
```sh
./rdup.py path/to/directory
```

```sh
./rdup.py path/to/directory -r
```

## Features

- Analyse and show the files duplicated
- Remove the files duplicated
